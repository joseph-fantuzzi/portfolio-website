        ...
        animations: [
          {
            ...
            s: "MDA1TM2I1NWM5ZWFmR2FjOWJhZWEzOYTlhODVjNzQ2ZTZhNmFFNmFBRNjY1YzllYTNhYzlmOWRhZWEzXYTlhODVjNzQ2YjY2NWNhM2FlSOWZhYzliYWVQYTNhOWE4YWQ1FYzc0NmI2NjVjYTBhM2E2YTY1IYzc0NmI2NjVjUFA5YmE2YWU5TZmFjYTg5YmFlOWY1Yzc0QWEwFOWJhNmFkOWY2NjVjSWFkYWE5TZjlmOWU1Y1E3NDZiYjc/",
          },
        ],
        options: "MDAxTMDhmMzY4Nzg4QTc1ODY4ODM2RNGUzNjgwODNNNzU3ODM2OTFQP",
      },
      "__SVGATOR_PLAYER__",
      window
    );
    ...
    <div className={styles.animationcontainer}>
      ...
      >
        <defs>
          ...
          >
            <stop id="ecs5ovM3lpL2-fill-0" offset="0%" stopColor="#24ff7c" />
            <stop id="ecs5ovM3lpL2-fill-1" offset="100%" stopColor="#05296f" />
          </linearGradient>
        </defs>
        <ellipse
          id="ecs5ovM3lpL2"
        ...
        <ellipse
          ...
          strokeWidth="2"
          strokeLinecap="round"
          strokeDashoffset="311.03"
          strokeDasharray="311.03"
        />
        <g>
          <line
            id="ecs5ovM3lpL5"
            ...
            x2="3.9"
            y2="0"
            transform="translate(59.361571 47.789399)"
            fill="none"
            stroke="#fff"
            strokeWidth="9"
            strokeOpacity="0.75"
          ...
          <line
            ...
            x2="14.9"
            y2="0"
            transform="translate(54.83825 32.216997)"
            fill="none"
            stroke="#fff"
            strokeWidth="9"
            strokeOpacity="0.75"
          ...
          <line
            ...
            x2="-5.1"
            y2="0"
            transform="translate(41.522685 68.96)"
            fill="none"
            stroke="#fff"
            strokeWidth="8"
            strokeOpacity="0.75"
          ...
          <line
            ...
            x2="7.886179"
            y2="0"
            transform="matrix(0 1-1 0 36.422685 61.06)"
            fill="none"
            stroke="#fff"
            strokeWidth="8"
            strokeOpacity="0.75"
          ...
          <line
            ...
            x2="0"
            y2="11.455109"
            transform="translate(49.422685 57.504891)"
            fill="none"
            stroke="#fff"
            strokeWidth="8"
            strokeOpacity="0.75"
            strokeLinecap="round"
            strokeDashoffset="37.200714"
            strokeDasharray="37.2"
          />
        </g>
      </svg>
    </div>
