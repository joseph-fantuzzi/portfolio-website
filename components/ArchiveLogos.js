import styles from "../styles/ArchiveLogos.module.css";
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_793_1403"
            result="shape"
          />
        </filter>
        <filter
          id="filter1_d_793_1403"
          x="31"
          y="70"
          width="40"
          height="13"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FCC65D" />
          <stop offset="1" stopColor="#DC4B4B" />
        </linearGradient>
      </defs>
    </svg>
  );
...
const ArchiveLogos = { PortfolioLogo, CryptoxLogo, ZitrousLogo };

export default ArchiveLogos;
