  ...
  bloomtech: {
    ...
    apprenticeship: {
      pr1: {
        name: "PR #1",
        date: "2022",
        technologies: ["JavaScript", "Node", "Express", "Knex", "PostgreSQL"],
    ...
    projects: {
      ...
      user_onboarding: {
        ...
        date: "2022",
        technologies: ["CSS", "JavaScript", "React", "Cypress"],
